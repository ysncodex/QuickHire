...
const Button = ({
  ...
  const variants = {
    // Changed to indigo to match your app's main branding
    primary: 'bg-indigo-600 text-white hover:bg-indigo-700 focus:ring-indigo-500',
    secondary: 'bg-gray-200 text-gray-900 hover:bg-gray-300 focus:ring-gray-500',
    // Added a ghost/text variant specifically for links like "Login"
    ghost:
  ...
  // If a 'to' prop is passed, render a React Router Link instead of a button
  if (to) {
    return (
  ...
  // Otherwise, render a standard form button
  return (
